...
from bad_research.web.base import WebResult, get_provider
...
def test_provider_disabled_when_module_missing(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(ImportError, match="bad-research\\[exa\\]"):
        get_provider("exa")


# --- Plan 03 Task 5: WebSearchProvider surface extensions ----------------------
